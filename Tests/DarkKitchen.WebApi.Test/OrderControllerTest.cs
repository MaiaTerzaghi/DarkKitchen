...
public class OrderControllerTest
{
    ...
    [TestMethod]
    public void MarkDelayedAsPrepared_ValidOrderId_ReturnsOkWithUpdatedStatus()
    {
        var orderId = 1;
        ...
        _orderServiceMock
            .Setup(s => s.MarkDelayedAsPrepared(orderId))
            .Returns(expectedResponse);

        var result = _controller.MarkDelayedAsPrepared(orderId);
    ...
    [TestMethod]
    public void MarkDelayedAsCancelled_ValidOrderId_ReturnsOkWithUpdatedStatus()
    {
        var orderId = 1;
        ...
        _orderServiceMock
            .Setup(s => s.MarkDelayedAsCancelled(orderId))
            .Returns(expectedResponse);

        var result = _controller.MarkDelayedAsCancelled(orderId);
